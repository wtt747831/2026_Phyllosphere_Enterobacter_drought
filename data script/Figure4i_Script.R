...
# Import data (copy data to clipboard first)
setwd("\\data_script\\sup_figs\\Figure 4i1")
data <- read_excel("Figure 4i1.xlsx")
df <- data
# View column names
colnames(df)

# ====================== Modification 1: Treatment grouping ======================
df$Treatment <- factor(df$Treatment, levels = c( "ck","Phenylalaine","Cinnamic acid","Caffeic acid"))
# ===============================================================================
...
mycolor <- c("#8FD2E6","#DFABCF","#A8D8B9","#F5BFA8")
# ==========================================================================================
